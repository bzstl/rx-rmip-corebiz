 ...
 */
package com.rx.rmip.corebiz.common.web;
...
import com.rx.rmip.corebiz.common.utils.FileUtils;
...
public class CKFinderConfig extends Configuration {
	...
	protected Configuration createConfigurationInstance() {
		...
		// }
		// boolean isView =
		// true;//UserUtils.getSubject().isPermitted("cms:ckfinder:view");
		// boolean isUpload =
		// true;//UserUtils.getSubject().isPermitted("cms:ckfinder:upload");
		// boolean isEdit =
		// true;//UserUtils.getSubject().isPermitted("cms:ckfinder:edit");
