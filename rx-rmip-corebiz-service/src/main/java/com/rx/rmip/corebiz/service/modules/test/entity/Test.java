 ...
 */
package com.rx.rmip.corebiz.service.modules.test.entity;
...
import com.rx.rmip.corebiz.common.persistence.DataEntity;
...
public class Test extends DataEntity<Test> {
	...
	@JsonIgnore
	public String getIngorevalue() {
		return ingorevalue;
	}

	@JsonIgnore
	public void setIngorevalue(String ingorevalue) {
		this.ingorevalue = ingorevalue;
	}
}
