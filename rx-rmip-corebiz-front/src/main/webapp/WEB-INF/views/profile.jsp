...
<html lang="en">
	<head>
		...
		<link rel="stylesheet" href="<%=basePath%>assets/css/jquery.gritter.min.css" />
		...
		<link rel="stylesheet" href="<%=basePath%>assets/css/bootstrap-editable.min.css" />
										...
										<div class="col-xs-12 col-sm-3 center">
											<div>
												<span class="profile-picture">
													<img id="avatar" class="editable img-responsive" alt="Alex's Avatar" src="<%=basePath%>assets/images/avatars/profile-pic.jpg" />
												</span>
													...
													<div class="widget-main padding-8">
														<div id="profile-feed-1" class="profile-feed">
															<div class="profile-activity clearfix">
																<div>
																	<img class="pull-left" alt="Alex Doe's avatar" src="<%=basePath%>assets/images/avatars/avatar5.png" />
															...
															<div class="profile-activity clearfix">
																<div>
																	<img class="pull-left" alt="Susan Smith's avatar" src="<%=basePath%>assets/images/avatars/avatar1.png" />
															...
															<div class="profile-activity clearfix">
																<div>
																	<img class="pull-left" alt="David Palms's avatar" src="<%=basePath%>assets/images/avatars/avatar4.png" />
											...
											<div class="tab-content no-border padding-24">
												<div id="home" class="tab-pane in active">
													<div class="row">
														<div class="col-xs-12 col-sm-3 center">
															<span class="profile-picture">
																<img class="editable img-responsive" alt="Alex's Avatar" id="avatar2" src="<%=basePath%>assets/images/avatars/profile-pic.jpg" />
															</span>
													...
													<div class="profile-users clearfix">
														<div class="itemdiv memberdiv">
															<div class="inline pos-rel">
																<div class="user">
																	<a href="#">
																		<img src="<%=basePath%>assets/images/avatars/avatar4.png" alt="Bob Doe's avatar" />
																	</a>
																</div>
														...
														<div class="itemdiv memberdiv">
															<div class="inline pos-rel">
																<div class="user">
																	<a href="#">
																		<img src="<%=basePath%>assets/images/avatars/avatar1.png" alt="Rose Doe's avatar" />
																	</a>
																</div>
														...
														<div class="itemdiv memberdiv">
															<div class="inline pos-rel">
																<div class="user">
																	<a href="#">
																		<img src="<%=basePath%>assets/images/avatars/avatar.png" alt="Jim Doe's avatar" />
																	</a>
																</div>
														...
														<div class="itemdiv memberdiv">
															<div class="inline pos-rel">
																<div class="user">
																	<a href="#">
																		<img src="<%=basePath%>assets/images/avatars/avatar5.png" alt="Alex Doe's avatar" />
																	</a>
																</div>
														...
														<div class="itemdiv memberdiv">
															<div class="inline pos-rel">
																<div class="user">
																	<a href="#">
																		<img src="<%=basePath%>assets/images/avatars/avatar2.png" alt="Phil Doe's avatar" />
																	</a>
																</div>
														...
														<div class="itemdiv memberdiv">
															<div class="inline pos-rel">
																<div class="user">
																	<a href="#">
																		<img src="<%=basePath%>assets/images/avatars/avatar3.png" alt="Susan Doe's avatar" />
																	</a>
																</div>
														...
														<div class="itemdiv memberdiv">
															<div class="inline pos-rel">
																<div class="user">
																	<a href="#">
																		<img src="<%=basePath%>assets/images/avatars/avatar1.png" alt="Jennifer Doe's avatar" />
																	</a>
																</div>
														...
														<div class="itemdiv memberdiv">
															<div class="inline pos-rel">
																<div class="user">
																	<a href="#">
																		<img src="<%=basePath%>assets/images/avatars/avatar3.png" alt="Alexa Doe's avatar" />
																	</a>
																</div>
													...
													<ul class="ace-thumbnails">
														<li>
															<a href="#" data-rel="colorbox">
																<img alt="150x150" src="<%=basePath%>assets/images/gallery/thumb-1.jpg" />
																<div class="text">
														...
														<li>
															<a href="#" data-rel="colorbox">
																<img alt="150x150" src="<%=basePath%>assets/images/gallery/thumb-2.jpg" />
																<div class="text">
																	<div class="inner">Sample Caption on Hover</div>
																</div>
															</a>
														...
														<li>
															<a href="#" data-rel="colorbox">
																<img alt="150x150" src="<%=basePath%>assets/images/gallery/thumb-3.jpg" />
																<div class="text">
																	<div class="inner">Sample Caption on Hover</div>
																</div>
															</a>
														...
														<li>
															<a href="#" data-rel="colorbox">
																<img alt="150x150" src="<%=basePath%>assets/images/gallery/thumb-4.jpg" />
																<div class="text">
																	<div class="inner">Sample Caption on Hover</div>
																</div>
															</a>
														...
														<li>
															<a href="#" data-rel="colorbox">
																<img alt="150x150" src="<%=basePath%>assets/images/gallery/thumb-5.jpg" />
																<div class="text">
																	<div class="inner">Sample Caption on Hover</div>
																</div>
															</a>
														...
														<li>
															<a href="#" data-rel="colorbox">
																<img alt="150x150" src="<%=basePath%>assets/images/gallery/thumb-6.jpg" />
																<div class="text">
																	<div class="inner">Sample Caption on Hover</div>
																</div>
															</a>
...
<![endif]-->
		...
		<script src="<%=basePath%>assets/js/jquery.hotkeys.index.min.js"></script>
		...
		<script src="<%=basePath%>assets/js/bootstrap-editable.min.js"></script>
		<script src="<%=basePath%>assets/js/ace-editable.min.js"></script>
