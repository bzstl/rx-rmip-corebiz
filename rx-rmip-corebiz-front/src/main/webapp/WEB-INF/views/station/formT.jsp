		...
		<td align="center">
			<div id="formcontent" style="width: 1000px; background-color: White;">
				<table border="0" cellpadding="0" cellspacing="0"
					...
					<tr>
						<td style="border: none" align="center" class="Title1" colspan="7">
							<span id="spanTitle">无线电台（站）设置申请表</span>
						</td>
					</tr>
					<tr style="height: 5pt;">
						<td colspan="7"></td>
									...
									<tr style="height: 18.45pt;">
										...
										<td colspan="5" class="tdBorderRight Title3Left" align="left">
											<table border="0" cellpadding="0" cellspacing="0"
												style="border-style: none; border-color: inherit; border-width: medium; background-color: White;">
												<tr style="height: 18.45pt;">
													<td><input id="selOrgName1" type="text" maxlength="80"
														name="orgApp.orgName" class="txtDefault stat_addr"
								...
								<table border="0" cellpadding="0" cellspacing="0"
									...
									<tr style="height: 18.45pt;">
										...
										<td class="tdBorderRight Title3" colspan="5"><input
											id="RadioNET_Area1" type="radio" name="net.netArea" value="1"
											class="required" /> <label for="RadioNET_Area1">
											...
											id="RadioNET_Area4" type="radio" name="net.netArea" value="4"
											class="required" /> <label for="RadioNET_Area4"> 省内</label>
											<input id="RadioNET_Area5" type="radio" name="net.netArea"
											value="5" class="required" /> <label for="RadioNET_Area5">
												地市</label>&nbsp; <input id="RadioNET_Area6" type="radio"
											name="net.netArea" value="6" class="required" /> <label
											for="RadioNET_Area6"> 县级</label> <input id="RadioNET_Area7"
											type="radio" name="net.netArea" value="7" class="required" />
											<label for="RadioNET_Area7"> 其他</label></td>
									</tr>
									<tr style="height: 18.45pt;">
								...
								<table id="appFreq1Table" border="0" cellpadding="0"
									...
									<tbody id="appFreq1Tbody">
										...
										<c:forEach varStatus="s" begin="0" end="5">
											<tr style="height: 18.45pt;">
												<td class="tdContent Title3"><input class="txtDefault"
													type="text" name="appfreqList[${s.count*2}].appFreqLc"
													style="width: 47%" /><span>/</span> <input
													class="txtDefault" type="text"
									...
									<tbody id="appFreq2Tbody">
										<tr style="height: 18.45pt;">
											...
											<td class="tdBorderRight Title3" colspan="2"><input
												...
												value="0" type="radio" /><label for="radio_rangeFreqUnit0_0">kHz</label>
												<input id="radio_rangeFreqUnit1_0"
												name="radio_rangeFreqUnit[0]" value="1" type="radio" /><label
												for="radio_rangeFreqUnit1_0">MHz</label> <input
												id="radio_rangeFreqUnit2_0" name="radio_rangeFreqUnit[0]"
												value="2" type="radio" /><label for="radio_rangeFreqUnit2_0">GHz</label>
											</td>
										</tr>
										<c:forEach varStatus="s" begin="0" end="4">
											<tr style="height: 18.45pt;">
												...
												<td class="tdBorderRight Title3" colspan="2"><input
													...
													type="radio" /><label for="radio_rangeFreqUnit0_${s.count}">kHz</label>
													<input id="radio_rangeFreqUnit1_${s.count}"
													name="radio_rangeFreqUnit[${s.count}]" value="1"
													type="radio" /><label for="radio_rangeFreqUnit1_${s.count}">MHz</label>
													<input id="radio_rangeFreqUnit2_${s.count}"
													name="radio_rangeFreqUnit[${s.count}]" value="2"
													type="radio" /><label for="radio_rangeFreqUnit2_${s.count}">GHz</label>
												</td>
											</tr>
										</c:forEach>
									</tbody>
											...
											<table border="0" cellpadding="0" cellspacing="0"
												...
												<tr style="height: 18.45pt;">
													...
													<td class="tdBorderRightCorner Title3"
														...
														<input id="date_APP_Date" name="apply.appDate" type="text"
