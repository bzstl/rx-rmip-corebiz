...
<title>国无管表1-F-无线频率使用申请表报表</title>
...
<!-- 下国无管表2的样式 -->
<link rel="stylesheet" type="text/css"
	href="${pageContext.request.contextPath }/assets/css/station/formF.css" />
<!-- 页面校验的样式 -->
<link rel="stylesheet" type="text/css"
					...
					<table border="0" cellpadding="0" cellspacing="0"
						...
						<tr>
							<td style="border: none" align="center" class="Title1"
								colspan="7"><span id="spanTitle">无线频率使用申请表</span></td>
						</tr>
						<tr style="height: 5pt;">
							<td colspan="7"></td>
						</tr>
							...
							<td colspan="7">
								<form id="form1">
									<table border="0" cellpadding="0" cellspacing="0"
										...
										<tr style="height: 18.45pt;" class="Title2">
											...
											<td style="border: none; text-align: right;" class="Title3"
												colspan="3">F<input id="txtAPP_Code1"
									...
									<table border="0" cellpadding="0" cellspacing="0"
										...
										<tr style="height: 18.45pt;" class="Title3Left">
											<td class="tdBorderLeft1 Title3" colspan="2">无线电系统/网络名称<span
												style="color: #FF0000;">*</span>
											</td>
											<td class="tdContent Title3Left">
												<input id="selNET_Name" type="text"
															name="net.netName" class="txtDefault"
															style="width: 98%" />
											</td>
											<td class="tdContent">
												卫星/星座名称
											...
											<td class="tdContent">
												<input id="" type="text"
															name="net.netSatName" class="txtDefault"
															style="width: 98%" />
											</td>
											<td class="tdContent">
												标称轨道经度
											...
											<td class="tdBorderRight">
												<input id="" type="text"
															name="net.netLg" class="txtDefault"
															style="width: 98%" />
											</td>
										</tr>
										<tr style="height: 18.45pt;">
									...
									<table id="appFreq1Table" border="0" cellpadding="0"
										...
										<tbody id="appFreq1Tbody">
											<tr style="height: 18.45pt;">
												<td class="tdBorderLeft Title3 appFreq1Title" rowspan="7">
													...
													for="radio_FREQ_Type0"> 申请信（波）道<br>的中心频率
												</label><br>
										...
										<tbody id="appFreq2Tbody">
											<tr style="height: 18.45pt;">
												<td class="tdBorderLeft Title3 appFreq2Title" rowspan="6">
													...
													for="radio_FREQ_Type1"> 申请频率范围</label><br>
										...
										<tfoot>
											<tr style="height: 18.45pt;">
												<td class="tdBorderLeft1 Title3" colspan="1">申请频率使用期限</td>
												<td class="tdBorderRight Title3Left" colspan="5"><input
												...
												<table border="0" cellpadding="0" cellspacing="0"
													...
													<tr style="height: 18.45pt;">
														<td colspan="7" class="fullLine Title3"
															...
															<p>2. 本单位如变更地址、名称等事项，将及时向无线电管理机构备案；</p>
															<p>3. 遵守国家有关无线电管理规定，并按时缴纳频率占用费。</p>
															<p></p>
														</td>
													</tr>
													<tr style="height: 18.45pt;">
										...
										<tbody id="appfilelistTbody">
											<tr style="height: 18.45pt;">
												<td rowspan="3" colspan="2"
													class="bottomTableLeft Title3 appfilelistTitle"
													style="width: 19.1%">附件名称列表<span
													style="color: #FF0000;">*</span><br> <span
													id="appfilelistBt" style="cursor: pointer">(+)</span>
												</td>
												<td class="bottomTableRight Title3Left" colspan="5"><input
									...
									<table border="0" cellpadding="0" cellspacing="0"
										...
										<tr>
											<td colspan="3"
												style="font-size: 7.5pt; color: #574d72; text-align: left">
												&nbsp;&nbsp;&nbsp;&nbsp;2006年版</td>
											<td colspan="3"
												style="font-size: 7.5pt; color: #574d72; text-align: right;">
												中华人民共和国信息产业部制&nbsp;&nbsp;&nbsp;&nbsp;</td>
										</tr>
									</table>
									<!--  </form> -->
