								...
								<div class="row">
									<div class="col-xs-12">
										...
										<div class="input-group" style="width: 300px">
											<input type="text" class="form-control" name="keywords" value="季度" placeholder="Look within results" />
										...
										<div class="btn-group" >
											<button data-toggle="dropdown" class="btn btn-info btn-lg dropdown-toggle" style="min-width: 160px;">
												<span class="type1">季 报 类 型</span><input type="hidden" class="type1" name="type1" value="0">
											...
											<ul class="dropdown-menu dropdown-success dropdown-menu-right">
												<li>
													<a onclick="textChange('span.type1','该季受理完结');$('input.type1').val('1');">该季受理完结</a>
												</li>
						
												<li>
													<a onclick="textChange('span.type1','非该季受理完结');$('input.type1').val('2');">非该季受理完结</a>
												</li>
												<li>
													<a onclick="textChange('span.type1','该季受理未完结');$('input.type1').val('3');">该季受理未完结</a>
												</li>
												<li>
													<a onclick="textChange('span.type1','非该季受理未完结');$('input.type1').val('4');">非该季受理未完结</a>
												</li>
											</ul>
										</div><!-- /.btn-group -->
