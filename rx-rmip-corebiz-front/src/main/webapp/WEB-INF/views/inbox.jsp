								...
								<div class="hide message-content" id="id-message-content">
									<div class="message-header clearfix">
										<div class="pull-left">
											...
											&nbsp;
											<img class="middle" alt="John's Avatar" src="<%=basePath%>assets/images/avatars/avatar.png" width="32" />
											&nbsp;
									...
									<div class="message-attachment clearfix">
										...
										<div class="attachment-images pull-right">
											...
											<div>
												<img width="36" alt="image 4" src="<%=basePath%>assets/images/gallery/thumb-4.jpg" />
												<img width="36" alt="image 3" src="<%=basePath%>assets/images/gallery/thumb-3.jpg" />
												<img width="36" alt="image 2" src="<%=basePath%>assets/images/gallery/thumb-2.jpg" />
												<img width="36" alt="image 1" src="<%=basePath%>assets/images/gallery/thumb-1.jpg" />
											</div>
										</div>
									</div>
								</div><!-- /.message-content -->
