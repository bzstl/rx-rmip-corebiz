								...
								<div class="row">
									<div class="col-xs-3">
										<a href="email-confirmation.html" class="thumbnail" target="_blank">
											<img class="img-responsive" src="<%=basePath%>assets/images/email/email1.png" alt="Email Template" />
										</a>
									</div>

									<div class="col-xs-3">
										<a href="email-navbar.html" class="thumbnail" target="_blank">
											<img class="img-responsive" src="<%=basePath%>assets/images/email/email2.png" alt="Email Template" />
										</a>
									</div>

									<div class="col-xs-3">
										<a href="email-newsletter.html" class="thumbnail" target="_blank">
											<img class="img-responsive" src="<%=basePath%>assets/images/email/email3.png" alt="Email Template" />
										</a>
									</div>

									<div class="col-xs-3">
										<a href="email-contrast.html" class="thumbnail" target="_blank">
											<img class="img-responsive" src="<%=basePath%>assets/images/email/email4.png" alt="Email Template" />
										</a>
									</div>
								</div>
