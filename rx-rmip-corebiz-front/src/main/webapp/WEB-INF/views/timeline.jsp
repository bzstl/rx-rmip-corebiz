												...
												<div class="timeline-items">
													<div class="timeline-item clearfix">
														<div class="timeline-info">
															<img alt="Susan't Avatar" src="<%=basePath%>assets/images/avatars/avatar1.png" />
																...
																<div class="widget-main">
																	<div class="clearfix">
																		...
																		<div class="pull-right">
																			...
																			&nbsp;
																			<img alt="Image 4" width="36" src="<%=basePath%>assets/images/gallery/thumb-4.jpg" />
																			<img alt="Image 3" width="36" src="<%=basePath%>assets/images/gallery/thumb-3.jpg" />
																			<img alt="Image 2" width="36" src="<%=basePath%>assets/images/gallery/thumb-2.jpg" />
																			<img alt="Image 1" width="36" src="<%=basePath%>assets/images/gallery/thumb-1.jpg" />
																			&nbsp;
