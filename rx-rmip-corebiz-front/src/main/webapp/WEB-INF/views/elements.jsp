				...
				*/
				...
				$('#gritter-regular').on(ace.click_event, function(){
					$.gritter.add({
						...
						image: '<%=basePath%>assets/images/avatars/avatar1.png', //in Ace demo ./dist will be replaced by correct <%=basePath%>assets path
						sticky: false,
						time: '',
				...
				$('#gritter-sticky').on(ace.click_event, function(){
					var unique_id = $.gritter.add({
						...
						image: '<%=basePath%>assets/images/avatars/avatar.png',
						sticky: true,
						time: '',
				...
				$('#gritter-max3').on(ace.click_event, function(){
					$.gritter.add({
						...
						image: '<%=basePath%>assets/images/avatars/avatar3.png', //in Ace demo ./dist will be replaced by correct <%=basePath%>assets path
						sticky: false,
