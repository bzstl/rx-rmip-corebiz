...
<![endif]-->
		...
		<script src="<%=basePath%>assets/js/markdown.min.js"></script>
		<script src="<%=basePath%>assets/js/bootstrap-markdown.min.js"></script>
	...
	*/
	...
	if ( typeof jQuery.ui !== 'undefined' && ace.vars['webkit'] ) {
		...
		if (typeof jQuery.ui !== 'undefined') enableImageResize();
			...
			$.getScript("<%=basePath%>assets/js/jquery-ui.custom.min.js", function(data, textStatus, jqxhr) {
				enableImageResize()
			});
		}
		*/
