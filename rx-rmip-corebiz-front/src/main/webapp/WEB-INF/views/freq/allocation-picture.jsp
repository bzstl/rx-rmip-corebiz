				...
				<div class="main-content-inner">
					...
					<div class="page-content">
						<div class="page-header">
							<h1>
								<small>
									<a href="${ctx }alloc/getAllocations" target=_blank>独立划分图</a>
								</small>
							</h1>
						</div><!-- /.page-header -->
						...
						<iframe id="iframepage" src="${ctx }alloc/getAllocations" scrolling="no" frameborder="0">
						</iframe>
...
<![endif]-->
		...
		<script type="text/javascript">
			$("#iframepage").width($(".page-header").width());
			/* var mid=($("#navbar").outerHeight(true)+$(".page-header").outerHeight(true)+$("#breadcrumbs").outerHeight(true))*1.7; */
			/* $("#iframepage").height($("body").height()-mid); */
			$("#iframepage").height($(window).height());
