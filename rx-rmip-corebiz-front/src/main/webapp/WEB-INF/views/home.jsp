															...
															<div class="itemdiv memberdiv">
																<div class="user">
																	<img alt="Bob Doe's avatar"
																		src="${ctx }assets/images/avatars/user.jpg" />
																</div>
															...
															<div class="itemdiv memberdiv">
																<div class="user">
																	<img alt="Joe Doe's avatar"
																		src="${ctx }assets/images/avatars/avatar2.png" />
																</div>
															...
															<div class="itemdiv memberdiv">
																<div class="user">
																	<img alt="Jim Doe's avatar"
																		src="${ctx }assets/images/avatars/avatar.png" />
																</div>
															...
															<div class="itemdiv memberdiv">
																<div class="user">
																	<img alt="Alex Doe's avatar"
																		src="${ctx }assets/images/avatars/avatar5.png" />
																</div>
															...
															<div class="itemdiv memberdiv">
																<div class="user">
																	<img alt="Susan's avatar"
																		src="${ctx }assets/images/avatars/avatar3.png" />
																</div>
															...
															<div class="itemdiv memberdiv">
																<div class="user">
																	<img alt="Phil Doe's avatar"
																		src="${ctx }assets/images/avatars/avatar4.png" />
																</div>
															...
															<div class="itemdiv memberdiv">
																<div class="user">
																	<img alt="Alexa Doe's avatar"
																		src="${ctx }assets/images/avatars/avatar1.png" />
																</div>
