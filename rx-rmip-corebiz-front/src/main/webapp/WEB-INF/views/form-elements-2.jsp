...
<html lang="en">
	<head>
		...
		<link rel="stylesheet" href="<%=basePath%>assets/css/bootstrap-multiselect.min.css" />
...
<![endif]-->
		...
		<script src="<%=basePath%>assets/js/jquery.raty.min.js"></script>
		<script src="<%=basePath%>assets/js/bootstrap-multiselect.min.js"></script>
		<script src="<%=basePath%>assets/js/select2.min.js"></script>
		<script src="<%=basePath%>assets/js/jquery-typeahead.js"></script>
